...
public class Main {
	...
	public static void main(String[] args) {
		...
		IronManSuit mark1_2 = mark1_1.clone();
		IronManSuit mark1_3 = mark1_1.clone();
		IronManSuit mark1_4 = mark1_1.clone();
		System.out.println("-------------------------------------");
		
		// 2. 아이언맨 슈트 Mark2를 생산합니다.
		IronManSuit mark2_1 = createMark2();
		IronManSuit mark2_2 = mark2_1.clone();
		IronManSuit mark2_3 = mark2_1.clone();
		IronManSuit mark2_4 = mark2_1.clone();
		System.out.println("-------------------------------------");
		
		// 3. 아이언맨 슈트 Mark3를 생산합니다.
		IronManSuit mark3_1 = createMark3();
		IronManSuit mark3_2 = mark3_1.clone();
		IronManSuit mark3_3 = mark3_1.clone();
		IronManSuit mark3_4 = mark3_1.clone();
		System.out.println("-------------------------------------");
